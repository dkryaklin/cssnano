...
This fixes a lossiness bug in `postcss-colormin` ([#1515](https://github.com/cssnano/cssnano/issues/1515)): colors like `rgba(221, 221, 221, 0.5)` were previously converted to `hsla(0,0%,87%,.5)`, which round-trips back to `rgb(222, 222, 222)` — a visibly different color at sharp image/UI boundaries. The new output `rgba(221,221,221,.5)` is fully lossless.
...
```css
/* Input */
rgba(221, 221, 221, 0.5)  →  rgba(221,221,221,.5)   /* lossless ✓ */
